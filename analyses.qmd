...
Expanding the data set and adding rows for with quantity equal to zero for 
cases where a taxa was not found. 
Note that when I add a this zero, the height category and height_cm column
is filled with NAs. 
